...
/**
 * The Handball class represents handball game statistics.
 */
public class Handball extends SportStatistics {
    private int group1Goals;
    private int group2Goals;

    /**
     * Constructs a Handball object with the given group players, coach name, and game date.
     *
     ...
     */
    public Handball(String[] group1Players, String[] group2Players, String coachName, Date gameDate) {
    ...
    /**
     * Returns a string representation of the handball game statistics.
     *
