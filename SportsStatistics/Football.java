...
/**
 * The Football class represents football game statistics.
 */
public class Football extends SportStatistics {
    private int group1Goals;
    private int group2Goals;

    /**
     * Constructs a Football object with the given group players, coach name, and game date.
     *
     ...
     */
    public Football(String[] group1Players, String[] group2Players, String coachName, Date gameDate) {
    ...
    /**
     * Returns a string representation of the football game statistics.
     *
